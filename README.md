...
Learn from Elixir apps written by experienced developers.

You'll find the source code for the Real World Elixir apps in the [`apps/`](apps/) subdirectory.

Thank you to every developer who has worked on a project this repo links to, your work is helping developers learn Elixir.

## How to install on your computer

```bash
# Clone this git repo:
git clone git@github.com:szTheory/real-world-elixir-apps.git

cd real-world-elixir-apps/
